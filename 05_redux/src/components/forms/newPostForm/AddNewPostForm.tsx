...
import { addCardForm } from '../../../store/reducers/cardFormListSlice';
...
const AddNewPostForm = () => {
  ...
  const [cards] = useState<(typeof initialState)[]>([]);
    ...
    <div>
      <div>
        <form onSubmit={handleSubmit(onFormSubmit)}>
          ...
          />
          <div className="nb-nav-post">
            <input type="submit" className="button" value="Add" />
          </div>
        </form>
      </div>
      {formSubmitted && <div className="form-submit-post">Card has been saved!</div>}
      <CardListForm />
    </div>
  );
};
